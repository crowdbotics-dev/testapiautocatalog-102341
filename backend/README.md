...
## Project Structure
    ...
    ├── testapiautocatalog_102341  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_102341`
...
2. Clone this repo and `cd testapiautocatalog_102341`
